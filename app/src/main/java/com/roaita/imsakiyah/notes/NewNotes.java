            ...
            public void onClick(View v) {
                try{
                    ...
                    if (!title.getText().toString().trim().isEmpty() && !content.getText().toString().trim().isEmpty() )
                    {
                        ...
                        nds.insertInfak("INFAK","PEMASUKAN","2323",title.getText().toString(),content.getText().toString()); //String type,String trx, String ket,String tgl, String nominal
                        Toast.makeText(getApplicationContext(),"Note Added.",Toast.LENGTH_LONG).show();
                        Intent i = new Intent(NewNotes.this, NoteActivity.class);
