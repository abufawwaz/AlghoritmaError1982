 ...
 */
package com.roaita.imsakiyah.file;
...
import com.roaita.imsakiyah.file.databinding.LayoutFileItemBinding;
import com.roaita.imsakiyah.file.util.FileType;
import com.roaita.imsakiyah.file.util.FileUtils;
...
class FileListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == 1) {
            View view = inflater.inflate(R.layout.file_empty_view, parent, false);
            return new EmptyViewHolder(view);
        } else {
            return new MyViewHolder(LayoutInflater.from(
                    mContext).inflate(R.layout.file_layout_file_item, parent,
                    false));
        }
    }
