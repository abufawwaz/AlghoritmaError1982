...
import com.roaita.imsakiyah.file.util.WifiUtils;
...
public class PopupMenuDialog {
    ...
    public PopupMenuDialog builder() {
        View view = LayoutInflater.from(context).inflate(
                R.layout.file_layout_popup_menu_dialog, null);
    ...
    void onWifiConnected(String ipAddr) {
        ...
        mTxtTitle.setTextColor(context.getResources().getColor(R.color.md_blue_900));
